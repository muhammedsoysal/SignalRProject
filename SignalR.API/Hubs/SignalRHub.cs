    ...
    public class SignalRHub : Hub
    {
        ...
        public SignalRHub(ICategoryService categoryService, IProductService productService, IOrderService orderService, IMoneyCaseService moneyCaseService, IMenuTableService menuTableService, IBookingService bookingService, INotificationService notificationService)
            ...
            public async Task SendStatistic()
            {
                ...
                var value5 = _productService.TProductCountByCategoryName("Hamburger");
                await Clients.All.SendAsync("ReceiveProductCountByCategoryNameHamburger", value5);

            var value6 = _productService.TProductCountByCategoryName("İçecekler");
            ...
            var value7 = _productService.TProductCountByCategoryName("Drink");
            ...
            var value9 = _productService.TProductPriceByName("SteakBurger");
            ...
            var notificationsListByFalse = _notificationService.TGetAllNotificationsByFalse();
            await Clients.All.SendAsync("ReceiveNotificationsListByFalse", notificationsListByFalse);
        }
